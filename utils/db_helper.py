...
def tableInit():
    ...
    cur.execute("INSERT INTO Apartments(ApartmentID, ApartmentAddress, BuildingID) values(2, '123 Main Rd', 2)")
    cur.execute("INSERT INTO Apartments(ApartmentID, ApartmentAddress, BuildingID) values(3, '123 Main Rd', 2)")
